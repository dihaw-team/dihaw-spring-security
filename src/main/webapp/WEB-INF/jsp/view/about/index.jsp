    ...
    <tiles:putAttribute name="body">
		<div class="about">
			...
			<p>	
				...
				The source code is available in <a href="https://github.com/dihaw-team/dihaw-spring-security" target="_blank">Github</a>.
			</p>
			...
			<ul>
				...
				<li>The <strong>log</strong> will be created on the <em>C:/dihaw/logs/dihaw-spring-security/SystemOut.log</em> file (see the <strong>logback.xml</strong> file)</li>
			</ul>
			</br></br>  
		</div>
    </tiles:putAttribute>
